...
// declare_id!("6darTnDdX4sXwWgKkTCzUryXmzkiNs2dkYgzYcx222L7"); // for dev net

#[cfg(feature = "local-testing")]
declare_id!("6darTnDdX4sXwWgKkTCzUryXmzkiNs2dkYgzYcx222L7"); // for local net
...
pub mod chicks_staking_locked {
    ...
    pub fn emit_price(ctx: Context<EmitPrice>, pool_handle: String) -> Result<()> {
    ...
    pub fn emit_reward(ctx: Context<EmitReward>, pool_handle: String) -> Result<()> {
